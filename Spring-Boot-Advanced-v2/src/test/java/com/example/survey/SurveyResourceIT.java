...
class SurveyResourceIT {
  ...
  void addNewSurveyQuestion_basicScenario() {
    ...
    String locationHeader = Objects.requireNonNull(responseEntity.getHeaders().get("Location")).get(0);
  ...
  private HttpHeaders createHttpContentTypeAndAuthorizationHeaders() {
    ...
    headers.add("Authorization", "Basic " + performBasicAuthEncoding());
    return headers;
  }


  String performBasicAuthEncoding() {
    String combined = "admin" + ":" + "password";
